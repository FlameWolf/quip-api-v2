...
import updateFileInfo from "../hooks/updateFileInfo";
...
const postsRouter: FastifyPluginAsync = async (instance, options) => {
	instance.post("/create", { onRequest: requireAuthentication, preValidation: [updateFileInfo, preValidatePostBody], schema: postCreateSchema }, postsController.createPost);
	...
	instance.post("/quote/:postId", { onRequest: requireAuthentication, preValidation: [updateFileInfo, preValidatePostBody], schema: postInteractAndCreateSchema }, postsController.quotePost);
	...
	instance.post("/reply/:postId", { onRequest: requireAuthentication, preValidation: [updateFileInfo, preValidatePostBody], schema: postInteractAndCreateSchema }, postsController.replyToPost);
